...
exports.XeroPartnerApi.prototype.makeSecureGet = function(access_token, access_token_secret, url, extraHeaders, callback) {
    ...
    this._consumer.get(url, access_token, access_token_secret, extraHeaders, done);
};